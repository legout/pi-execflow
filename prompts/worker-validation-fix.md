---
description: Worker subagent validation/fix loop for delegated execflow
...
1. Resolve the work item and relevant ExecPlan if not already clear from parent chain context.
...
# Worker Validation/Fix Iteration
