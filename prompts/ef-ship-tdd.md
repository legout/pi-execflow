...
chain: ship-tdd-resolve -> spec -> implement -> validation-fix --loop 5 -> ef-review-with-followups -> finalize
...
Run `/ef-update` or `/ef-init`, then retry `/ef-ship-tdd [<work-item-ref>|--next]`.
