---
name: ticket-testing
description: Derive high-signal validation from ticket acceptance criteria and assess the quality of test evidence. Use for ticket test planning, validation, and review of test adequacy.
---

# Ticket Testing

Use this skill when designing or assessing ticket validation.
...
If the task starts from a ticket reference rather than an already-open ticket document or a prior chain step that already resolved the ticket, first read `../ticket-resolution/SKILL.md` and follow it.
...
- the validation is relevant to the ticket
