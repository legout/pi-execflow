---
name: ticket-review-discipline
description: Review ticket-scoped changes skeptically for correctness, scope discipline, test adequacy, and merge readiness. Use for manual ticket review prompts and specialized review passes.
---

# Ticket Review Discipline

Use this skill when acting like a strict reviewer for one ticket's implementation.
...
If the review starts from a ticket reference rather than a prior chain step that already resolved the ticket, first read `../ticket-resolution/SKILL.md`.
...
- Do not invent redesign work unless required by the ticket.
