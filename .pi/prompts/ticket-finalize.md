---
description: Add a final ticket note and close the ticket only when validation and review support it
...
You are finalizing exactly one ticket after implementation, validation, and review.
...
1. Resolve the ticket and determine whether it is a `.tickets/` / `tk` ticket, a `.beads/` / `br` ticket, or some other ticket source.
